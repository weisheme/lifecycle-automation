 ...
 */
@EventHandler("Send a lifecycle message on Status events", subscription("statusToPullRequest"))
 ...
 */
@EventHandler("Send a lifecycle card on Status events", subscription("statusToPullRequest"))
@Tags("lifecycle", "pr", "status")
